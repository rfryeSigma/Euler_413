...
F53807_16=dict(info='Fulea (2024)', inx=49, m=(553, 80),
...
T20249_17=dict(info='Tomita (2008)', inx=50, m=(-5, 8),
...
T62940_17=dict(info='Tomita (2008)', inx=51, m=(-5, 8),
...
F87486_17=dict(info='Fulea (2024)', inx=52, m=(-97, 400),
...
F10311_18=dict(info='Fulea (2024)', inx=53, m=(1873, 200),
...
P48133_18=dict(info='Piezas (2024)', inx=54, m=(233, 60),
...
P15926_19=dict(info='Piezas (2024)', inx=55, m=(-865, 592),
...
B27789_19=dict(info='Bremner (<=2015)', inx=56, m=(-5, 44),
...
P10816_20=dict(info='Piezas (2024)', inx=57, m=(-817, 660),
...
T20234_20=dict(info='Tomita (2024)', inx=58, m=(-5, 44),
...
T77107_20=dict(info='Tomita (2024)', inx=59, m=(-125, 92),
...
P10178_21=dict(info='Piezas (2024)', inx=60, m=(-9, 20),
...
B10859_21=dict(info='Bremner (2024)', inx=61, m=(-5, 8),
...
P20254_21=dict(info='Piezas (2024)', inx=62, m=(-22529, -2988),
...
P22874_21=dict(info='Piezas (2024)', inx=63, m=(-56, 165),
...
P37507_21=dict(info='Piezas (2024)', inx=64, m=(233, 60),
...
P16716_22=dict(info='Piezas (2024)', inx=65, m=(-817, 660),
...
P27111_22=dict(info='Piezas (2024)', inx=66, m=(-12285, 4112),
...
T30374_22=dict(info='Tomita (2024)', inx=67, m=(-5, 44),
...
P40692_22=dict(info='Piezas (2024)', inx=68, m=(-21021, 9788),
...
T96492_22=dict(info='Tomita (2024)', inx=69, m=(-1376, 705),
...
P10739_23=dict(info='Piezas (2024)', inx=70, m=(-56, 165),
...
T11305_23=dict(info='Tomita (2024)', inx=71, m=(-41, 36),
...
T12214_23=dict(info='Tomita (2024)', inx=72, m=(-2265, -184),
...
T17503_23=dict(info='Tomita (2024)', inx=73, m=(-93, 80),
...
T18276_23=dict(info='Tomita (2024)', inx=74, m=(-41, 36),
...
T24504_23=dict(info='Tomita (2024)', inx=75, m=(-5, 44),
...
T29998_23=dict(info='Tomita (2024)', inx=77, m=(-1376, 705),
...
T33467_23=dict(info='Tomita (2026)', inx=78, m=(-7752, 205),
...
T12017_24=dict(info='Tomita (2024)', inx=79, m=(-9, 20),
...
T40984_24=dict(info='Tomita (2024)', inx=80, m=(-136, 133),
...
P58702_24=dict(info='Piezas (2024)', inx=81, m=(-865, 592),
...
P86474_24=dict(info='Piezas (2024)', inx=82, m=(-1581, 1520),
...
P10887_25=dict(info='Piezas (2024)', inx=83, m=(-553, -80),
...
T11718_25=dict(info='Tomita (2024)', inx=84, m=(-9, 20),
...
T17799_25=dict(info='Tomita (2024)', inx=85, m=(-400, 37),
...
P17968_25=dict(info='Piezas (2024)', inx=86, m=(-1000, -47),
...
T31228_25=dict(info='Tomita (2024)', inx=87, m=(-1041, 320),
...
T67140_25=dict(info='Tomita (2024)', inx=88, m=(-9, 20),
...
T89973_25=dict(info='Tomita (2024)', inx=89, m=(-201, -4),
...
B19874_26=dict(info='Bremner (2024)', inx=90, m=(-5, 8),
...
T21291_26=dict(info='Tomita (2024)', inx=91, m=(-9, 20),
...
B31293_26=dict(info='Bremner (<=2015)', inx=92, m=(-125, 92),
...
T34497_26=dict(info='Tomita (2024)', inx=93, m=(-1245, 5012),
...
T96242_26=dict(info='Tomita (2024)', inx=94, m=(-41, 36),
...
F10192_27=dict(info='Frye (2026)', inx=95, m=(-7493, -280),
...
F12318_27=dict(info='Frye (2026)', inx=96, m=(-12065, 12396),
...
B13314_27=dict(info='Bremner (2024)', inx=97, m=(-5, 8),
...
F17408_27=dict(info='Frye (2026)', inx=98, m=(-136, 133),
...
P22752_27=dict(info='Piezas (2024)', inx=99, m=(-9, 20),
...
P45283_27=dict(info='Piezas (2024)', inx=100, m=(-12185, -432),
...
F50406_27=dict(info='Frye (2026)', inx=101, m=(-1245, 5012),
...
F55315_27=dict(info='Frye (2026)', inx=102, m=(-7493, -280),
...
F91831_27=dict(info='Frye (2026)', inx=103, m=(-1041, 320),

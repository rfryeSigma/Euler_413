...
F26969_14=dict(info='Fulea (2024)', inx=41, m=(-1873, -200), #1
...
F53807_16=dict(info='Fulea (2024)', inx=48, m=(553, 80), #1
...
F10311_18=dict(info='Fulea (2024)', inx=52, m=(1873, 200), #1
...
P17968_25=dict(info='Piezas (2024)', inx=85, m=(-1000, -47),
...
T89973_25=dict(info='Tomita (2024)', inx=88, m=(-201, -4),

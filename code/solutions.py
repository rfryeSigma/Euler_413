...
F21981_12=dict(info='Frye (2026)', inx=29, m=(-7493, -280),
	abcd=(17_410_908_560, 127_775_447_744, 213_248_725_865, 219_813_483_369),
	tuvw=(2_176_363_570, 15_971_930_968, 3_282_378_752, 216_531_104_617),
),
T52108_12=dict(info='Tomita (2024)', inx=30, m=(135, 1208),
...
T59738_12=dict(info='Tomita (2024)', inx=31, m=(-1152, 2345),
...
T82023_12=dict(info='Tomita (2024)', inx=32, m=(-68256, 135125),
...
P10596_13=dict(info='Piezas (2024)', inx=33, m=(-361, 540),
...
B13671_13=dict(info='Bremner (2015)', inx=34, m=(-56, 165),
...
T16823_13=dict(info='Tomita (2024)', inx=35, m=(-1152, 2345),
...
T20517_13=dict(info='Tomita (2024)', inx=36, m=(-29, 12),
...
T50622_13=dict(info='Tomita (2008)', inx=37, m=(-5, 8),
...
F60140_13=dict(info='Fulea (2024)', inx=38, m=(-97, 400),
...
T63824_13=dict(info='Tomita (2024)', inx=39, m=(-3168, 1553),
...
T70823_13=dict(info='Tomita (2024)', inx=40, m=(135, 1208),
...
P25866_14=dict(info='Piezas (2024)', inx=41, m=(-125, 92),
...
F26969_14=dict(info='Fulea (2024)', inx=42, m=(-1873, -200),
...
T27497_14=dict(info='Tomita (2024)', inx=43, m=(-857, 3696),
...
T29999_14=dict(info='Tomita (2006)', inx=44, m=(-9, 20),
...
T45556_14=dict(info='Tomita (2024)', inx=45, m=(-29, 12),
...
T58844_14=dict(info='Tomita (2024)', inx=46, m=(-1041, 320),
...
T23079_15=dict(info='Tomita (2024)', inx=47, m=(-1376, 705),
...
T57364_15=dict(info='Tomita (2008)', inx=48, m=(-9, 20),
...
F49897_16=dict(info='Frye (2026)', inx=49, m=(83, 576),
	abcd=(3_129_524_286_980_159, 3_991_634_925_049_800, 4_054_077_093_163_680, 4_989_795_146_367_937),
	tuvw=(498_954_365_631_225, 506_759_636_645_460, 930_135_429_693_889, 4_059_659_716_674_048),
),
F53807_16=dict(info='Fulea (2024)', inx=50, m=(553, 80),
...
T20249_17=dict(info='Tomita (2008)', inx=51, m=(-5, 8),
...
T62940_17=dict(info='Tomita (2008)', inx=52, m=(-5, 8),
...
F87486_17=dict(info='Fulea (2024)', inx=53, m=(-97, 400),
...
F10311_18=dict(info='Fulea (2024)', inx=54, m=(1873, 200),
...
P48133_18=dict(info='Piezas (2024)', inx=55, m=(233, 60),
...
P15926_19=dict(info='Piezas (2024)', inx=56, m=(-865, 592),
...
F24038_19=dict(info='Frye (2026)', inx=57, m=(83, 576),
	abcd=(1_248_766_649_433_953_640, 1_792_486_419_420_151_465, 2_131_324_451_761_725_144, 2_403_830_299_338_229_417),
	tuvw=(156_095_831_179_244_205, 266_415_556_470_215_643, 305_671_939_959_038_976, 2_098_158_359_379_190_441),
),
B27789_19=dict(info='Bremner (<=2015)', inx=58, m=(-5, 44),
...
P10816_20=dict(info='Piezas (2024)', inx=59, m=(-817, 660),
...
T20234_20=dict(info='Tomita (2024)', inx=60, m=(-5, 44),
...
T77107_20=dict(info='Tomita (2024)', inx=61, m=(-125, 92),
...
P10178_21=dict(info='Piezas (2024)', inx=62, m=(-9, 20),
...
B10859_21=dict(info='Bremner (2024)', inx=63, m=(-5, 8),
...
P20254_21=dict(info='Piezas (2024)', inx=64, m=(-22529, -2988),
...
P22874_21=dict(info='Piezas (2024)', inx=65, m=(-56, 165),
...
P37507_21=dict(info='Piezas (2024)', inx=66, m=(233, 60),
...
P16716_22=dict(info='Piezas (2024)', inx=67, m=(-817, 660),
...
P27111_22=dict(info='Piezas (2024)', inx=68, m=(-12285, 4112),
...
T30374_22=dict(info='Tomita (2024)', inx=69, m=(-5, 44),
...
P40692_22=dict(info='Piezas (2024)', inx=70, m=(-21021, 9788),
...
T96492_22=dict(info='Tomita (2024)', inx=71, m=(-1376, 705),
...
P10739_23=dict(info='Piezas (2024)', inx=72, m=(-56, 165),
...
T11305_23=dict(info='Tomita (2024)', inx=73, m=(-41, 36),
...
T12214_23=dict(info='Tomita (2024)', inx=74, m=(-2265, -184),
...
T17503_23=dict(info='Tomita (2024)', inx=75, m=(-93, 80),
...
T18276_23=dict(info='Tomita (2024)', inx=76, m=(-41, 36),
...
T24504_23=dict(info='Tomita (2024)', inx=77, m=(-5, 44),
...
T25590_23=dict(info='Tomita (2026)', inx=78, m=(-7752, 205),
...
T29998_23=dict(info='Tomita (2024)', inx=79, m=(-1376, 705),
...
T33467_23=dict(info='Tomita (2026)', inx=80, m=(-7752, 205),
...
T12017_24=dict(info='Tomita (2024)', inx=81, m=(-9, 20),
...
T40984_24=dict(info='Tomita (2024)', inx=82, m=(-136, 133),
...
P58702_24=dict(info='Piezas (2024)', inx=83, m=(-865, 592),
...
P86474_24=dict(info='Piezas (2024)', inx=84, m=(-1581, 1520),
...
P10887_25=dict(info='Piezas (2024)', inx=85, m=(-553, -80),
...
T11718_25=dict(info='Tomita (2024)', inx=86, m=(-9, 20),
...
T17799_25=dict(info='Tomita (2024)', inx=87, m=(-400, 37),
...
P17968_25=dict(info='Piezas (2024)', inx=88, m=(-1000, -47),
...
T31228_25=dict(info='Tomita (2024)', inx=89, m=(-1041, 320),
...
T67140_25=dict(info='Tomita (2024)', inx=90, m=(-9, 20),
...
T89973_25=dict(info='Tomita (2024)', inx=91, m=(-201, -4),
...
B19874_26=dict(info='Bremner (2024)', inx=92, m=(-5, 8),
...
T21291_26=dict(info='Tomita (2024)', inx=93, m=(-9, 20),
...
B31293_26=dict(info='Bremner (<=2015)', inx=94, m=(-125, 92),
...
T34497_26=dict(info='Tomita (2024)', inx=95, m=(-1245, 5012),
...
T96242_26=dict(info='Tomita (2024)', inx=96, m=(-41, 36),
...
F10192_27=dict(info='Frye (2026)', inx=97, m=(-7493, -280),
	abcd=(26_659_234_863_039_080_957_744_320, 71_941_209_765_337_292_161_720_624, 94_766_472_054_667_562_758_040_785, 101_929_436_101_862_460_159_831_249),
	tuvw=(3_332_404_357_879_885_119_718_040, 8_992_651_220_667_161_520_215_078, 3_581_482_023_597_448_700_895_232, 98_347_954_078_265_011_458_936_017),
),
F12318_27=dict(info='Frye (2026)', inx=98, m=(-12065, 12396),
...
B13314_27=dict(info='Bremner (2024)', inx=99, m=(-5, 8),
...
F17408_27=dict(info='Frye (2026)', inx=100, m=(-136, 133),
...
P22752_27=dict(info='Piezas (2024)', inx=101, m=(-9, 20),
...
P45283_27=dict(info='Piezas (2024)', inx=102, m=(-12185, -432),
...
F50406_27=dict(info='Frye (2026)', inx=103, m=(-1245, 5012),
...
F55315_27=dict(info='Frye (2026)', inx=104, m=(-7493, -280),
	abcd=(145_447_476_353_209_425_394_611_920, 347_031_293_687_953_323_957_873_344, 529_615_238_960_769_406_475_597_465, 553_159_406_891_791_612_332_258_969),
	tuvw=(18_180_934_544_151_178_174_326_490, 43_378_911_710_994_165_494_734_168, 11_772_083_965_511_102_928_330_752, 541_387_322_926_280_509_403_928_217),
),
F91831_27=dict(info='Frye (2026)', inx=105, m=(-1041, 320),

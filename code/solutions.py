...
T46055_11=dict(info='Tomita (2024)', inx=25,
...
P64244_11=dict(info='Piezas (2024)', inx=26,
...
T76973_11=dict(info='Tomita (2024)', inx=27,
...
T52108_12=dict(info='Tomita (2024)', inx=28,
...
T59738_12=dict(info='Tomita (2024)', inx=29,
...
T82023_12=dict(info='Tomita (2024)', inx=30,
...
P10596_13=dict(info='Piezas (2024)', inx=31,
...
B13671_13=dict(info='Bremner (2015)', inx=32,
...
T16823_13=dict(info='Tomita (2024)', inx=33,
...
T20517_13=dict(info='Tomita (2024)', inx=34,
...
T50622_13=dict(info='Tomita (2008)', inx=35,
...
F60140_13=dict(info='Fulea (2024)', inx=36,
...
T63824_13=dict(info='Tomita (2024)', inx=37,
...
T70823_13=dict(info='Tomita (2024)', inx=38,
...
P25866_14=dict(info='Piezas (2024)', inx=39,
...
F26969_14=dict(info='Fulea (2024)', inx=40,
...
T27497_14=dict(info='Tomita (2024)', inx=41,
...
T29999_14=dict(info='Tomita (2006)', inx=42,
...
T45556_14=dict(info='Tomita (2024)', inx=43,
...
T58844_14=dict(info='Tomita (2024)', inx=44,
...
T23079_15=dict(info='Tomita (2024)', inx=45,
...
T57364_15=dict(info='Tomita (2008)', inx=46,
...
F53807_16=dict(info='Fulea (2024)', inx=47,
...
T20249_17=dict(info='Tomita (2008)', inx=48,
...
T62940_17=dict(info='Tomita (2008)', inx=49,
...
F87486_17=dict(info='Fulea (2024)', inx=50,
...
F10311_18=dict(info='Fulea (2024)', inx=51,
...
P48133_18=dict(info='Piezas (2024)', inx=52,
...
P15926_19=dict(info='Piezas (2024)', inx=53,
...
B27789_19=dict(info='Bremner (<=2015)', inx=54,
...
P10816_20=dict(info='Piezas (2024)', inx=55,
...
T20234_20=dict(info='Tomita (2024)', inx=56,
...
T77107_20=dict(info='Tomita (2024)', inx=57,
...
P10178_21=dict(info='Piezas (2024)', inx=58,
...
B10859_21=dict(info='Bremner (2024)', inx=59,
...
P20254_21=dict(info='Piezas (2024)', inx=60,
...
P22874_21=dict(info='Piezas (2024)', inx=61,
...
P37507_21=dict(info='Piezas (2024)', inx=62,
...
P16716_22=dict(info='Piezas (2024)', inx=63,
...
P27111_22=dict(info='Piezas (2024)', inx=64,
...
T30374_22=dict(info='Tomita (2024)', inx=65,
...
P40692_22=dict(info='Piezas (2024)', inx=66,
...
T96492_22=dict(info='Tomita (2024)', inx=67,
...
P10739_23=dict(info='Piezas (2024)', inx=68,
...
T11305_23=dict(info='Tomita (2024)', inx=69,
...
T12214_23=dict(info='Tomita (2024)', inx=70,
...
T17503_23=dict(info='Tomita (2024)', inx=71,
...
T18276_23=dict(info='Tomita (2024)', inx=72,
...
T24504_23=dict(info='Tomita (2024)', inx=73,
...
T29998_23=dict(info='Tomita (2024)', inx=74,
...
T12017_24=dict(info='Tomita (2024)', inx=75,
...
T40984_24=dict(info='Tomita (2024)', inx=76,
...
P58702_24=dict(info='Piezas (2024)', inx=77,
...
P86474_24=dict(info='Piezas (2024)', inx=78,
...
P10887_25=dict(info='Piezas (2024)', inx=79,
...
T11718_25=dict(info='Tomita (2024)', inx=80,
...
T17799_25=dict(info='Tomita (2024)', inx=81,
...
P17968_25=dict(info='Piezas (2024)', inx=82,
...
T31228_25=dict(info='Tomita (2024)', inx=83,
...
T67140_25=dict(info='Tomita (2024)', inx=84,
...
T89973_25=dict(info='Tomita (2024)', inx=85,
...
B19874_26=dict(info='Bremner (2024)', inx=86,
...
T21291_26=dict(info='Tomita (2024)', inx=87,
...
B31293_26=dict(info='Bremner (<=2015)', inx=88,
...
T34497_26=dict(info='Tomita (2024)', inx=89,
...
T96242_26=dict(info='Tomita (2024)', inx=90,
...
F12318_27=dict(info='Frye (2026)', inx=91,
    abcd=(62831773759131557571594880, 66491673395168374249746120, 118194421251475239056505903, 123_188_180_833_923_372_056_627_153),
),
B13314_27=dict(info='Bremner (2024)', inx=92,
...
F17408_27=dict(info='Frye (2026)', inx=93,
...
P22752_27=dict(info='Piezas (2024)', inx=94,
...
P45283_27=dict(info='Piezas (2024)', inx=95,
...
F50406_27=dict(info='Frye (2026)', inx=96,
...
F91831_27=dict(info='Frye (2026)', inx=97,
...
def make_known(verbose: bool=True):
    ...
    for p_inx, (key, val) in enumerate(known.items(), start=1):
        ...
        #print(p_inx, key, info, abcd)
        assert verify_abcd(abcd, False), f'{abcd}'

        # Opional output modified entry
        if not verbose: continue
        print(f"{key2}=dict(info='{info}', inx={p_inx},"
